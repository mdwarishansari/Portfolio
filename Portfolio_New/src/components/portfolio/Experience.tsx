                        ...
                        <div className="border-t border-white/10 p-5 sm:p-6">
                          ...
                          {exp.certificateAvailable && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="mt-5 inline-flex items-center gap-2 rounded-full border border-amber/50 px-4 py-2 text-[12px] tracking-[0.02em] text-amber transition-colors hover:bg-amber/10"
                            >
