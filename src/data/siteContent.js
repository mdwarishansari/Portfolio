...
export const siteContent = {
  ...
  contact: {
    hireSubject: "Hire from Portfolio",
    hireBody:
  ...
  hero: {
    greeting: "Hello!",
    typeSequencePrefix: ["I", 500, "I am", 1000],
    roles: [
    ...
    primaryCta: "Hire Me",
    secondaryCta: "See What I've Built",
  },

  about: {
    profileImage: profileGif,
    imageAlt: "Warish animated",
    greeting: "Hello!",
    titlePrefix: "I am",
    description:
    ...
    projectsCta: "See What I've Built",
    stats: [
  ...
  footer: {
    ...
    backToTopCta: "↑ Back to Top",
    journeyHeading: "Development Journey",
    fuelText: "Fueled by countless cups of coffee",
    philosophyHeading: "Development Philosophy",
    philosophy:
    ...
    craftedSuffix: "using React, Tailwind CSS &",
    splineLabel: "Spline",
    splineLink:
      "https://app.spline.design/community/file/8cfb6748-f3dd-44dd-89fb-f46c7ab4186e",
    stats: [
